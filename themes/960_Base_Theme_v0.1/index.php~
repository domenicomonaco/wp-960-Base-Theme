...
<?php while (have_posts()) : the_post(); ?>
	<div class="post post-front-page">
		<h2><span class="data_t">
		<?php the_time('d.m.y') ?></span><img src="<?php bloginfo('template_directory'); ?>/i/row_data.jpg" /> <a href="<?php the_permalink() ?>" rel="bookmark"><?php the_title(); ?></a></h2>           

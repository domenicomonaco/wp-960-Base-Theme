...
<?php // Do not delete these lines
	...
	if (!empty($post->post_password)) { // if there's a password
		if ($_COOKIE['wp-postpass_' . COOKIEHASH] != $post->post_password) {  // and it doesn't match the cookie
			...
			<p class="nocomments">Questo contenuto è protetto da password. Inserisci la password per visualizzare i commenti.</p>
	...
	<?php foreach ($comments as $comment) : ?>
		...
		<li <?php echo $oddcomment; ?>id="comment-<?php comment_ID() ?>">
			<div class="cdata">
				...
				<em>Il tuo commento è stato inserito con successo, ma sarà visibile solo dopo l'approvazione dell'amministratore</em>
				<?php endif; ?>
